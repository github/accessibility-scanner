    ...
    steps:
      - uses: github/accessibility-scanner@v3
        with:
          ...
          # ignore_https_errors: false # Optional: Set to true to ignore HTTPS errors when scanning URLs with self-signed certificates
...
| `ignore_https_errors`     | No       | Whether to ignore HTTPS errors when scanning URLs with self-signed certificates. Default: `false`                                                                                                                                                                | `true`                                                                      |
